...
export const RegisterPage = memo(() => {
  ...
  return (
    <AuthLayout reverse={true} chatPreview={<ChatPreview />}>
      <div className="space-y-8">
        {/* Header */}
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-bold text-white">Start building in minutes</h1>
          <p className="text-white/60">Create your account and deploy your first ML model today.</p>
        </div>
        ...
        {/* Social Login */}
        <SocialButton provider="google" onClick={handleGoogleSignup} disabled={isLoading} />

        {/* Sign In Link */}
        <div className="text-center">
          <p className="text-white/60">
            Already have an AutoML account?{' '}
            <a href="/signin" className="text-[#4169ff] hover:text-[#5179ff] font-medium transition-colors">
              Sign In
            </a>
          </p>
        </div>
